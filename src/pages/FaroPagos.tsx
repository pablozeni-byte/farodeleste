    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pb-24">
        ...
        >
          ...
          <div className="container mx-auto px-4 lg:px-8 relative">
            <div className="max-w-4xl mx-auto">
              <div className="p-8 rounded-2xl bg-gradient-to-br from-primary/60 to-primary/30 border border-accent/10">
                ...
                <p className="text-muted-foreground mb-8 pl-0 md:pl-[76px] text-lg leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pl-0 md:pl-[76px]">
                  {[
                    ...
                    <motion.div
                      ...
                      className="group p-5 rounded-xl bg-background/80 border border-accent/20 hover:border-accent/40 transition-all duration-300 hover:shadow-lg hover:shadow-accent/5"
                    >
                      ...
                      <span className="text-foreground font-medium block">{item.text}</span>
        ...
        <motion.section
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="py-20 bg-gradient-to-b from-primary/50 to-primary/70 relative overflow-hidden"
        >
          {/* Tech Pattern */}
          <div className="absolute left-0 top-0 opacity-5">
            <Server className="w-48 h-48 text-destructive" />
          </div>
          <div className="absolute right-0 bottom-0 opacity-5">
            <Database className="w-40 h-40 text-destructive" />
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="flex items-start gap-5 mb-10">
                ...
                <div>
                  ...
                  <div className="h-1 w-20 bg-gradient-to-r from-destructive/50 to-transparent rounded-full mt-3" />
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pl-0 md:pl-[76px]">
                {[
                  ...
                  <motion.div 
                    ...
                    className="flex items-start gap-4 p-5 rounded-xl bg-background/70 border border-border hover:border-destructive/20 transition-all duration-300"
                  >
                    <div className="p-3 rounded-xl bg-destructive/10 flex-shrink-0">
                      <item.icon className="w-5 h-5 text-destructive/80" strokeWidth={1.5} />
                    </div>
                    <div>
                      <span className="text-foreground font-medium block">{item.text}</span>
        ...
        <motion.section
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="py-20 bg-gradient-to-b from-primary/50 to-primary/70"
        >
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pl-0 md:pl-[76px]">
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: 0.1 }}
                  className="group p-8 rounded-2xl bg-background border border-accent/15 hover:border-accent/30 transition-all duration-300 hover:shadow-xl hover:shadow-accent/5"
                >
                  <div className="flex items-center gap-4 mb-5">
                    ...
                    <h3 className="font-semibold text-foreground text-lg">Android (Chrome)</h3>
                  </div>
                ...
                >
                  <div className="flex items-center gap-4 mb-5">
                    ...
                    <h3 className="font-semibold text-foreground text-lg">iPhone (Safari)</h3>
                  </div>
                  <div className="flex items-center gap-3 text-muted-foreground">
          ...
          <div className="container mx-auto px-4 lg:px-8 relative">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-10">
                <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-3">Resumen</h2>
              ...
              <div className="rounded-2xl border border-accent/20 overflow-hidden shadow-xl shadow-accent/5">
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gradient-to-r from-accent/15 to-accent/5 hover:bg-accent/15">
                      ...
                      <TableHead className="text-destructive font-semibold py-5">
                        <div className="flex items-center gap-3">
                  ...
                  <TableBody>
                    {[
                      ...
                      <TableRow key={index} className="hover:bg-primary/30 transition-colors">
        ...
        >
          ...
          <div className="container mx-auto px-4 lg:px-8 relative">
            <div className="max-w-4xl mx-auto">
              <div className="p-12 rounded-3xl bg-gradient-to-br from-primary/60 via-primary/40 to-accent/10 border border-accent/20 text-center">
                ...
                <h3 className="text-2xl font-semibold text-foreground mb-4">¿Listo para simplificar tus pagos?</h3>
                <p className="text-muted-foreground mb-8">Accedé directamente a DGI y BPS sin complicaciones.</p>
                <Button 
                  variant="goldAccent" 
                  size="lg" 
